...
- **9** reusable contractor-photography source sets cover the recurring excavation story; all **9** source sets now have approved desktop masters.
...
| `PHOTO-C05` | Contractor using TULBOXX one-handed beside equipment or from a parked truck between tasks | `HOME-FIELD-07`, `WHY-FIELD-07`, `FEATURES-MOBILE-06` | Three desktop masters approved | Produce mobile portrait, optimized exports, and real UI composites |
| `PHOTO-C06` | Contractor handling a customer call from a parked truck with the active job visible outside | `WORKFLOW-CALL-02`, `FEATURES-CUSTOMERS-02` | Desktop master approved | Environmental call master, mobile crop, background-brand cleanup, optimized exports |
...
## Capture Status — August 14, 2026

The complete fictional Ridgeline demonstration fixture now exists in an isolated local environment, and a first real-product capture pass is stored under `assets/images/approved/app/`. Captures use TULBOXX V2 commit `84fd0e4`; no production customer data was accessed or copied.

| Capture ID | Status | Approved source | Remaining gap, if any |
|---|---|---|---|
...
4. Use approved `PHOTO-C06` and `PHOTO-C07` to connect customer and crew coordination to real work.
