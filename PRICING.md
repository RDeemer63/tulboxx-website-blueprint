...
TULBOXX Pricing | Get the Ground Floor Rate
...
Use a simple branded pricing summary. Avoid lifestyle photography, promotional bursts, or unverified savings claims.

---

# Global Page Rules

- Publish exact pricing wherever possible.
- Explain billing frequency, taxes, fees, limits, and renewal clearly.
- Never invent plan names, prices, discounts, trial terms, or guarantees.
...
- Keep visual design restrained so the decision remains central.
...
The public copy contains no placeholders, but checkout and legal implementation must still confirm:
...
**Asset ID:** `PRICING-HERO-01`

Use a quiet Steel Blue and Tradesman White composition with clear typography and generous spacing. No large lifestyle image is needed.
...
- No feature tiers
- Rate remains $39 while the subscription stays active
...
# Section 3 - Ground Floor Rate

## Headline

Get the whole platform at the ground-floor price.
...
Contractors and service business owners who want to get in early and grow with TULBOXX.
...
- All current TULBOXX features
- Future TULBOXX features as the platform grows
- Connected customers, projects, estimates, jobs, invoices, and payments
- Mobile and desktop access where supported
- AI assistance with contractor review
- No feature tiers for Ground Floor customers

**Rate protection**

Your $39 monthly rate remains locked for the life of your active subscription.
...
**Asset ID:** `PRICING-PLANS-02`

Use one prominent offer card. The visual emphasis should come from clarity and the value of joining early—not a fake “Most Popular” badge.

---

# Section 4 - Shared Value
...
Explain the value of including the entire platform without creating artificial tiers.

## Included Outcomes

- Keep customer and project information connected
- Work from mobile and desktop
- Create professional customer documents
- Keep work moving toward billing and payment
- Use supported AI assistance with contractor review
- Benefit from new TULBOXX features as the platform grows

## Rule

The complete verified feature inventory in `FEATURES.md` defines what “all features” means at launch.
...
One rate. The whole TULBOXX platform.
...
- Mark every verified feature as included rather than comparing nonexistent tiers.
- Explain meaningful product or usage limitations honestly.
- Link unfamiliar capabilities to plain-language explanations in `FEATURES.md`.
- Keep the list grouped and readable on mobile.

## Visual Direction

**Asset ID:** `PRICING-INCLUDED-03`

This component is information design, not decoration. Use clear grouping and checkmarks sparingly. Do not make one complete offer look like a comparison table.

---

# Section 6 - Value and ROI

## Copy

**Eyebrow**

The price is only one side of the decision.
...
Late estimates, repeated entry, forgotten follow-ups, delayed invoices, and owner time all carry a cost.

Use your own numbers to explore the potential value of recovering time or winning one additional job.
...
- Value of owner or office time
- Average invoice or collection delay

## Optional Outputs

- Estimated value of recovered time
- Value of one additional closed job
- Modeled monthly opportunity
- Comparison with plan cost

## Required Disclaimer

Results are estimates based on the visitor's inputs and stated assumptions. They are not promises, guarantees, or typical customer results.

## Visual Direction

**Asset ID:** `PRICING-ROI-04`

Keep the calculator simple, immediate, and transparent. Show the equation or assumptions behind every result. Do not prefill exaggerated values.

## Launch Rule

If inputs, assumptions, or outputs cannot be defended, omit the calculator and use a plain value explanation instead.

---

# Section 7 - Payment and Add-On Transparency

## Headline

Know what else can affect the total.

## Required Disclosures When Applicable

- Additional users
- Payment-processing fees
- SMS, email, AI, storage, or usage limits
...
If a cost is reasonably foreseeable, do not make the visitor discover it after signup.

---

# Section 8 - Objections and FAQ
...
FAQs must answer real uncertainty. They are not a place for keyword stuffing or evasive language.

## Visual Direction

**Asset ID:** `PRICING-FAQ-05`

Use an accessible accordion or open text sections. Critical pricing and cancellation facts must not exist only inside collapsed content.
...
**Asset ID:** `PRICING-CTA-06`

Keep this section quiet and confident. Summarize the established value. Do not add countdowns, fake scarcity, or a new discount argument.
...
- Prioritize typography, spacing, and information hierarchy.
- Use product UI only when it clarifies an inclusion.
- Avoid large lifestyle photography.
- Use accent color for selection and action, not decoration.
- Do not animate prices in a distracting way.
- Respect reduced motion and maintain WCAG AA contrast.
...
The page, checkout, sales materials, and product must not contradict this source.

---

# Future Pricing Review - Internal Planning Only

Do not publish future plan names, tiers, or prices before V2 and the relevant roadmap are reviewed.

When Ground Floor enrollment is ready to close:

1. Inventory the capabilities completed in V2.
2. Review the near-term roadmap and cost-to-serve.
3. Identify genuinely different customer needs by company stage, users, usage, or advanced capability.
4. Decide whether one straightforward standard plan still serves customers best.
5. Create tiers only when each tier has a clear customer, value boundary, and reason to exist.
6. Validate pricing against customer value and willingness to pay.
7. Set and communicate the Ground Floor close event before standard pricing begins.

Existing Ground Floor customers retain their $39 monthly rate and all-feature access for the life of their active subscription when standard pricing changes.
...
- ROI-calculator use
- FAQ engagement
- Ground Floor signup completion path
...
- Which objections prevent progress?

Do not manipulate defaults solely to increase short-term conversion.
...
- Announce any dynamic price or checkout changes accessibly.
- Do not communicate offer conditions through color alone.
- Make included-feature groups and accordions keyboard accessible.
- Show complete price and billing units near every CTA.
- Avoid a wide tier-comparison table while only one offer exists.
- Keep calculator inputs properly labeled and validated.
- Use minimal JavaScript and avoid heavy media.
- Ensure the decision remains possible if interactive enhancements fail.
...
- Included-feature data matches the product and checkout.
- ROI assumptions are transparent and defensible.
...
> I need to talk to someone just to understand what this costs.

It should leave them thinking:

> I understand the investment, the value, and exactly what to do next.
...
This document governs the strategy, copy structure, offer requirements, comparison logic, visual intent, and acceptance criteria for the TULBOXX Pricing page.
