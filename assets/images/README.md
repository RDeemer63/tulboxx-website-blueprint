...
## `PHOTO-C05` Candidate V1

- **File:** [`review/shared/photo-c05-field-use-candidate-v1.png`](review/shared/photo-c05-field-use-candidate-v1.png)
- **Prompt record:** [`review/shared/photo-c05-field-use-candidate-v1.prompt.md`](review/shared/photo-c05-field-use-candidate-v1.prompt.md)
- **Status:** Awaiting visual approval
- **Dimensions:** 1535 × 1024
- **Source:** Generated by Codex from the rejected trench concept and the approved `HOME-HERO-01` identity/style reference
...
- **Proposed alt text:** Excavation contractor checks his phone from stable ground beside a muddy work truck while a drainage trench and excavator remain visible.
- **Review notes:** Safety, identity, hands, phone, lighting, equipment context, and visible branding passed the initial review. Confirm the contractor likeness and overall composition before promotion to `approved/shared/`.
