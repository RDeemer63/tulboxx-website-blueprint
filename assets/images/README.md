...
| `APP-03` | [`approved/app/app-03-project-overview-desktop.png`](approved/app/app-03-project-overview-desktop.png) | 1418 × 985 | Backyard Drainage and Grading project showing its approved estimate, completed job, paid invoice, and recent activity. | Approved desktop capture. |
| `APP-03` | [`approved/app/app-03-project-overview-mobile.png`](approved/app/app-03-project-overview-mobile.png) | 375 × 812 | Mobile project overview connecting Morgan Lee's approved estimate, completed job, and paid invoice. | Approved after the underlying responsive overflow was fixed in app commit `0f51730`. |
...
| `APP-06` | [`approved/app/app-06-ai-estimate-input-desktop.png`](approved/app/app-06-ai-estimate-input-desktop.png) | 1440 × 1000 | TULBOXX estimate input with plain-language project details and a button to build an AI-assisted field quote. | Approved input state. |
| `APP-06` | [`approved/app/app-06-ai-estimate-draft-desktop.png`](approved/app/app-06-ai-estimate-draft-desktop.png) | 1253 × 705 | AI-generated drainage estimate draft shown beside its preserved approved version in TULBOXX estimate history. | Approved generated-output and explicit-review state. The temporary fictional draft was removed after capture. |
| `APP-07` | [`approved/app/app-07-estimate-review-desktop.png`](approved/app/app-07-estimate-review-desktop.png) | 1253 × 705 | Editable AI-generated drainage scope with contractor controls to sharpen, add, revise, or remove individual items. | Approved contractor editing state. |
...
| `APP-08` | [`approved/app/app-08-customer-estimate-mobile.png`](approved/app/app-08-customer-estimate-mobile.png) | 375 × 812 | Mobile customer estimate showing Morgan Lee the drainage project scope and total. | Approved mobile capture for customer-conversation composites. |
...
| `APP-14` | [`approved/app/app-14-paid-invoice-history-mobile.png`](approved/app/app-14-paid-invoice-history-mobile.png) | 375 × 812 | Mobile paid-invoice history showing the collected total, zero balance, and recorded bank-transfer payment. | Approved mobile capture for payment-review composites. |
...
These candidates preserve the approved photography and place real captured TULBOXX pixels inside the photographed devices. They remain in review until the complete scene and screen choice are approved together.

| Candidate | File | Dimensions | Proposed alt text | Review notes |
|---|---|---:|---|---|
| `PHOTO-C03 + APP-08` | [`review/composites/photo-c03-app08-customer-estimate-composite-v1.png`](review/composites/photo-c03-app08-customer-estimate-composite-v1.png) | 1536 × 1024 | Excavation contractor shows a customer the drainage estimate on his phone outside the customer's home. | Real mobile customer-estimate capture placed into the approved customer-conversation photograph. |
| `PHOTO-C05 + APP-10` | [`review/composites/photo-c05-app10-job-detail-composite-v1.png`](review/composites/photo-c05-app10-job-detail-composite-v1.png) | 1536 × 1024 | Excavation contractor reviews connected job details on his phone at the tailgate beside an active residential jobsite. | Real mobile job-detail capture placed into the approved field-use photograph. |
| `PHOTO-C08 + APP-14` | [`review/composites/photo-c08-app14-payment-history-composite-v1.png`](review/composites/photo-c08-app14-payment-history-composite-v1.png) | 1536 × 1024 | Excavation contractor reviews a paid invoice and payment history on his phone while seated in his parked work truck. | Real mobile payment-history capture placed into the approved payment-review photograph. |
